...
import { UserActivityEditComponent } from './edit/user-activity-edit.component';
import { UserActivityListComponent } from './list/user-activity-list.component';
...
export class UserActivityComponentsModule { }