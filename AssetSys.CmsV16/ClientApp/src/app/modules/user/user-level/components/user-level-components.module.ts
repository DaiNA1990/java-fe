...
import { UserLevelEditComponent } from './edit/user-level-edit.component';
import { UserLevelListComponent } from './list/user-level-list.component';
...
export class UserLevelComponentsModule { }