...
import { UserTitleEditComponent } from './edit/user-title-edit.component';
import { UserTitleListComponent } from './list/user-title-list.component';
...
@NgModule({
    declarations: [
        UserTitleEditComponent,
        UserTitleListComponent,
    ],
    exports: [
        UserTitleListComponent,
    ],
...
export class UserTitleComponentsModule { }