...
import { UserConnectionEditComponent } from './edit/user-connection-edit.component';
import { UserConnectionListComponent } from './list/user-connection-list.component';
...
@NgModule({
    declarations: [
        UserConnectionEditComponent,
        UserConnectionListComponent,
    ],
    exports: [
        UserConnectionListComponent,
    ],
...
export class UserConnectionComponentsModule { }